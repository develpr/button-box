...
<tr><td align="right">IFTTT Key</td><td><input type="text" id="iftttKey" name="iftttKey" value=""></td></tr>
<tr><td align="right">Trigger #1</td><td><input type="text" id="trigger1" name="trigger1" value=""></td></tr>
<tr><td align="right">Trigger #2</td><td><input type="text" id="trigger2" name="trigger2" value=""></td></tr>
<tr><td align="right">Trigger #3</td><td><input type="text" id="trigger3" name="trigger3" value=""></td></tr>
...
void send_network_configuration_html()
{
	...
	if (server.args() > 0 )  // Save Settings
	{
		...
		for ( uint8_t i = 0; i < server.args(); i++ ) {
			...
			if (server.argName(i) == "trigger1") config.trigger1 =   urldecode(server.arg(i));
      if (server.argName(i) == "trigger2") config.trigger2 =   urldecode(server.arg(i));
      if (server.argName(i) == "trigger3") config.trigger3 =   urldecode(server.arg(i));
...
void send_network_configuration_values_html()
{
  ...
  values += "trigger1|" +  (String) config.trigger1 + "|input\n";
  values += "trigger2|" +  (String) config.trigger2 + "|input\n";
  values += "trigger3|" +  (String) config.trigger3 + "|input\n";
